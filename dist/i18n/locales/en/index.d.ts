...
export declare const English: {
    ...
    readonly common: {
        ...
        readonly 'download-event-history-json': "Download Event History JSON";
        ...
        readonly 'pending-and-failed': "Pending and Failed";
        readonly 'pending-and-failed-description': "View only Pending, Failed, and Timed Out events";
    ...
    readonly workflows: {
        ...
        readonly 'copy-search-input': "Copy Raw Query";
    ...
    readonly events: {
        ...
        readonly 'view-raw-history': "View Raw History";
    };
    readonly schedules: {
