export const Namespace = 'workflows';
export const Strings = {
    ...
    'workflows-error-querying': 'A error has occurred while querying for Workflows.',
    'filtered-workflows-count': 'Results {{filtered, number}} of {{total, number}} workflows',
    terminate: 'Terminate',
    ...
    'batch-confirmation_one': 'Are you sure you want to {{action}} one running workflow?',
    'batch-confirmation_other': 'Are you sure you want to {{action}} {{count, number}} running workflows?',
    'batch-reset-confirmation_one': 'Are you sure you want to reset one workflow?',
    'batch-reset-confirmation_other': 'Are you sure you want to reset {{count, number}} workflows?',
    'batch-operation-confirmation-input-hint': 'If you supply a custom reason, "{{placeholder}}" will be appended to it. If you omit a reason, the placeholder will be used.',
    'batch-terminate-all-success': 'The batch terminate request is processing in the background.',
    'batch-cancel-all-success': 'The batch cancel request is processing in the background.',
    'batch-reset-all-success': 'The batch reset request is processing in the background.',
    'configure-headers': 'Configure {{title}}',
    'close-configure-headers': 'Close {{title}} configuration',
    'configure-headers-description': 'Add (<1></1>), re-arrange (<2></2>), and remove (<3></3>), {{type}} to personalize the {{title}} Table.',
    ...
    'reset-disabled-unauthorized': 'Resetting workflows is not enabled, please contact your administrator for assistance.',
    'reset-disabled-pending-children': 'Cannot reset workflows with pending children.',
    'reset-disabled-no-events': 'Cannot reset workflows without WorkflowTaskStarted, WorkflowTaskCompleted, or WorkflowTaskTimedOut events.',
    'signal-disabled': 'Signaling workflows is not enabled, please contact your administrator for assistance.',
    'update-disabled': 'Updating workflows is not enabled, please contact your administrator for assistance.',
    'terminate-disabled': 'Terminating workflows is not enabled, please contact your adminstrator for assistance.',
    ...
    'reset-reapply-type-label': 'Reapply Signals that happened after the Reset point',
    'reset-exclude-signals': 'Exclude Signals that happened after the Reset point.',
    'reset-exclude-updates': 'Exclude Updates that happened after the Reset point.',
    'cancel-modal-title': 'Cancel Workflow',
    'cancel-modal-confirmation': 'Are you sure you want to cancel this workflow? This action cannot be undone.',
    'terminate-modal-title': 'Terminate Workflow',
    'terminate-modal-confirmation': 'Are you sure you want to terminate this workflow? This action cannot be undone.',
    ...
    'cancel-request-sent-description': "The request to cancel this Workflow Execution has been sent. If the Workflow uses the cancellation API, it'll cancel at the next available opportunity.",
    'reset-success-alert-title': 'This Workflow has been reset',
    'reset-success-alert-description': 'You can find the resulting Workflow Execution <1>here</1>.',
    'history-tab': 'History',
    ...
    'workflow-error-title': 'We are having technical difficulties retrieving this Workflow',
    'workflow-error-no-workers-title': 'No Workers Running',
    'workflow-error-no-workers-description': 'There are no Workers polling the {{taskQueue}} Task Queue.',
    'workflow-error-no-compatible-workers-title': 'No Compatible Workers Running',
    'workflow-error-no-compatible-workers-description': 'There are no compatible Workers polling the {{taskQueue}} Task Queue.',
    ...
    'no-workers-failure-message': 'This will fail if you have no workers running.',
    'no-workers-running-message': 'Please make sure you have at least one worker running.',
    'call-stack-alert': 'This is a call stack showing each location where Workflow code is waiting.',
    ...
    'empty-state-description': 'If you have filters applied, try adjusting them. Otherwise please check your syntax and try again.',
    ...
    'workflow-query-empty-state-preface': 'There are no results for the applied filters.',
    'workflow-query-empty-state-postface': 'Try adjusting or clearing the filters to see the Workflows running on this Namespace.',
    ...
    'visibility-disabled-archival': 'This namespace is currently enabled for archival but visibility is not enabled.',
    'archival-link-preface': 'To enable ',
    'archival-link': 'archival visibility',
    'archival-disabled-title': 'This namespace is currently not enabled for archival.',
    'archival-disabled-details': 'Run this command to enable archival visibility for event histories',
    'archival-empty-state-description': 'No results found for archival visibility.',
    'basic-search': 'Basic Search',
    'advanced-search': 'Advanced Search',
    'time-range': 'Time Range',
    'pending-activities-link': 'Show all Pending Activities',
    'duration-filter-placeholder': 'e.g. "2h45m", "hh:mm:ss", or "1000" nanoseconds',
    ...
    'markdown-description': 'Markdown is supported in the summary and details fields. You can use {namespace}, {workflowId} or {runId} syntax in link href to create dynamic links based on the page you are on. Images are not allowed.',
