...
const temporal = plugin(({ addComponents, addBase }) => {
    addBase({
        ':root': light,
    ...
    theme: {
        ...
        backgroundColor: ({ theme }) => ({
            ...
            'interactive-secondary-hover': css('--color-interactive-secondary-hover'),
            'interactive-secondary-active': css('--color-interactive-secondary-active'),
