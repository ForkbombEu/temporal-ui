...
export type Replace<T, U extends {
    [key: string]: unknown;
}> = Omit<T, keyof U> & U;
...
export type ClusterInformation = import('./').GetClusterInfoResponse;
export type SystemInformation = import('./').GetSystemInfoResponse;
